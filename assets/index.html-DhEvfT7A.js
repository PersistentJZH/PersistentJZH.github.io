...
<span class="line"><span>  └──────────────────┘</span></span></code></pre></div><p>关键结论：</p><ul><li><strong>文件内容存在磁盘数据块中</strong>，inode 记录&quot;数据块在哪里&quot;</li><li><strong>文件名存在目录里</strong>，只是 inode 号的&quot;别名&quot;</li><li><strong>硬链接就是让一个 inode 有多个文件名</strong>，删除文件只是删了一个目录项，inode 的链接计数减 1；减到 0 才真正释放数据块</li><li><strong>软链接本身也是一个 inode</strong>，但它的数据块存的不是文件内容，而是&quot;目标路径&quot;这个字符串</li></ul>`,11)),n("blockquote",null,[n("p",null,[s[1]||(s[1]=i("详细 inode 原理见 ")),t(p,{href:"/linux/inode/"},{default:l(()=>s[0]||(s[0]=[i("Linux inode 详解")])),_:1,__:[0]}),s[2]||(s[2]=i("。"))])]),s[7]||(s[7]=a(`<h2 id="二、硬链接的规则和限制" tabindex="-1"><a class="header-anchor" href="#二、硬链接的规则和限制"><span>二、硬链接的规则和限制</span></a></h2><h3 id="_2-1-硬链接的-三不-原则" tabindex="-1"><a class="header-anchor" href="#_2-1-硬链接的-三不-原则"><span>2.1 硬链接的&quot;三不&quot;原则</span></a></h3><div class="language-bash" data-highlighter="shiki" data-ext="bash" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-bash"><span class="line"><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD;"># 1. 不能跨文件系统</span></span>
